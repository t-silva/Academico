...
public class metodosEclasses { //declarando Classe que iniciará a execução do programa;
	...
	r.base = ler.nextDouble(); //Utilizando atributo base no objeto r, já instanciado com a classe Retangulo;
	System.out.print("Digite o valor da altura: ");
	r.altura = ler.nextDouble(); //Utilizando atributo base no objeto r, já instanciado com a classe Retangulo;
...
public class Retangulo{ // Declarando classe Retangulo.
	double base; // Atributos dessa classe incluirao base (double) e altura(double)
	double altura;
